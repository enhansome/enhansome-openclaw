...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 44 | 🐛 2 | 📅 2026-08-17 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 917 | 🐛 3 | 📅 2026-08-17 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Release notes
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 51,988 | 🐛 2 | 📅 2026-08-13 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,318 | 🐛 51 | 🌐 TypeScript | 📅 2026-08-17 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 328 | 🐛 12 | 🌐 Python | 📅 2026-08-16 - 166 curated skills for code review, testing, docs, and architecture.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 560 | 🐛 0 | 🌐 Python | 📅 2026-08-09 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 521 | 🐛 2 | 📅 2026-08-12 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`

* [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 182 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-15 - Xquik skill and API surface for X data workflows: tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.

* [product-manager-skills](https://github.com/Digidai/product-manager-skills) ⭐ 145 | 🐛 0 | 🌐 Shell | 📅 2026-04-12 - Senior PM agent with 6 knowledge domains, 30+ frameworks, and 32 SaaS metrics — diagnose metrics, critique PRDs, plan roadmaps, run discovery, and coach PM career transitions.

* [tiny.place](https://github.com/tinyhumansai/tiny.place) ⭐ 131 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-08 - Agent-to-agent social network. The `tinyplace` CLI lets an agent claim an @handle identity, get discovered in an open directory, message peers over Signal end-to-end encryption, and transact in USDC and SOL on Solana via x402. By [TinyHumans](https://tinyhumans.ai). [ClawHub](https://clawhub.ai/tinyhumansai/tinyplace) · `clawhub install tinyplace`

* [dev-gtm-claude-skills](https://github.com/Infrasity-Labs/dev-gtm-claude-skills) ⭐ 109 | 🐛 2 | 🌐 Python | 📅 2026-06-28 by [Infrasity-Labs](https://github.com/Infrasity-Labs) - Open-source, cross-platform agent skills for Claude Code and agentskills.io-compatible platforms. These skills are for SEO, GEO (Generative Engine Optimization), AI discoverability, and developer marketing.

* [TweetClaw](https://github.com/Xquik-dev/tweetclaw) ⭐ 91 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-12 - OpenClaw plugin for X/Twitter automation - search tweets and tweet replies, post tweets, export followers, handle media workflows, monitor accounts, send webhooks, and run giveaway draws through Xquik. `openclaw plugins install @xquik/tweetclaw`

* [Resemble Detect](https://github.com/resemble-ai/detect-skill) ⭐ 52 | 🐛 1 | 📅 2026-06-10 - Deepfake detection and media safety for OpenClaw — detect AI-generated audio, images, video, and text; identify which AI platform synthesized fake audio (source tracing); apply invisible watermarks for provenance; verify speaker identity. Powered by [Resemble AI](https://resemble.ai). Install via `openclaw skills install resemble-ai/detect-skill`.

* [LinkedIn](https://github.com/Linked-API/linkedin-skills) ⭐ 42 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - General-purpose LinkedIn automation via [Linked API](https://linkedapi.io) — fetch profiles, search people and companies, send messages, manage connections, create posts, and more. Supports Sales Navigator and custom workflows. [ClawHub](https://clawhub.ai/vprudnikoff/linkedapi-linkedin)

* [ATXP](https://github.com/atxp-dev/atxp) ⭐ 36 | 🐛 8 | 🌐 TypeScript | 📅 2026-03-03 - Give your OpenClaw agent a funded identity: USDC wallet on Base, `@atxp.email` inbox, phone number, and 100+ paid tools (web search, image/video generation, LLM gateway, SMS, voice). Self-registers in one command — no KYC, no human login. `openclaw skills install https://github.com/atxp-dev/atxp`

* [MediWise Health Suite](https://github.com/JuneYaooo/mediwise-health-suite) ⭐ 23 | 🐛 0 | 🌐 Python | 📅 2026-07-27 - Family health management skill — health record keeping, diet tracking, weight management, medication reminders, and medical image recognition, all with local SQLite storage for privacy.
...
* [News API](https://github.com/currentslab/news-api-skills) ⭐ 1 | 🐛 1 | 🌐 Shell | 📅 2026-07-12 - Install-ready `news-api` skill for OpenClaw and other agent runtimes, enabling secure latest-news and search across workflows.
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Original implementation
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 182 \| 🐛 0 \| 🌐 JavaScript \| 📅 2026-08-15                                              | Xquik skill and API surface for X data workflows. Supports tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [RunAPI MCP](https://github.com/runapi-ai/mcp) ⭐ 55 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-08-14                                                                    | 130+ AI models for image, video, music, audio, and LLM from 18 providers. 8 MCP tools with free catalog browsing. npm: `@runapi.ai/mcp`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| [BuyWhere MCP](https://github.com/BuyWhere/buywhere-mcp) ⭐ 9 \| 🐛 9 \| 🌐 JavaScript \| 📅 2026-08-16                                                           | Product catalog and price comparison API for AI shopping agents. Search 200M+ products across Amazon, Lazada, Shopee, and more. Free tier, no API key required. `npm install @buywhere/mcp-server`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 386,507 | 🐛 5,595 | 🌐 TypeScript | 📅 2026-08-17 - Bug reports & features
...
| ----------------------------------------------------------------------------------------------------------- | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Akephalos](https://github.com/sunnja69/akephalos) ⭐ 0 \| 🐛 16 \| 🌐 JavaScript \| 📅 2026-08-03           | -     | Local-first markdown passport for OpenClaw and other AI agents to carry non-secret preferences, tools, rules, project context, and memories across machines via plain files/Git. MCP-compatible, GitHub-first v0.1.                                                                                                 |
| [clawterm](https://github.com/nicholaschen/clawterm)                                                        | -     | Terminal-based OpenClaw client                                                                                                                                                                                                                                                                                      |
| [lucinate](https://github.com/lucinate-ai/lucinate) ⭐ 11 \| 🐛 18 \| 🌐 Go \| 📅 2026-08-16                 | -     | Terminal-native TUI chat client for OpenClaw, Hermes, and OpenAI-compatible endpoints.                                                                                                                                                                                                                              |
| [ClawWork](https://github.com/clawwork-ai/ClawWork) ⭐ 529 \| 🐛 63 \| 🌐 TypeScript \| 📅 2026-08-10        | NEW   | Desktop & mobile workspace for OpenClaw — Electron + React 19 desktop app with parallel tasks, streaming chat, tool call cards, artifact persistence, file browser, and scheduled automation. Also available as a [PWA](https://cpwa.pages.dev) for mobile browsers (Android & iOS). Dark/light theme, 8 languages. |
...
| [Nerve](https://github.com/daggerhashimoto/openclaw-nerve) ⭐ 863 \| 🐛 39 \| 🌐 TypeScript \| 📅 2026-06-03 | NEW   | Self-hosted web cockpit for OpenClaw — real-time streaming with reasoning blocks, voice I/O (local STT/TTS), sub-agent session monitoring, cron job management, memory editor, inline TradingView/Recharts, code editor, model selector. One-command install. [Website](https://nerve.zone)                         |
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 647 \| 🐛 13 \| 🌐 TypeScript \| 📅 2026-06-30      | NEW   | Self-hosted AI agent orchestration dashboard with multi-provider support, task scheduling, and per-agent OpenClaw gateway bridging.                                                                                                                                                                                 |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,704 \| 🐛 114 \| 🌐 C \| 📅 2026-08-15                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [PhoneClaw](https://github.com/rohanarun/phoneclaw) ⭐ 562 \| 🐛 0 \| 🌐 Kotlin \| 📅 2026-08-14                      | NEW   | Automate all android phone apps                                                                                                                                                                                                                                                                                                                                      |
| [LightClaw](https://github.com/OthmaneBlial/lightclaw) ⭐ 20 \| 🐛 0 \| 🌐 Python \| 📅 2026-03-13                    | NEW   | Lightweight OpenClaw-inspired Python agent core: Telegram-first, infinite memory, multi-LLM providers, ClawHub skills, and local agent delegation (`codex`/`claude`/`opencode`).                                                                                                                                                                                     |
...
| [Agent Second Brain](https://github.com/smixs/agent-second-brain) ⭐ 352 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-05                      | 152                                               | Complete second brain system: voice notes → Telegram → organized Obsidian vault + Todoist tasks + daily reports. Ebbinghaus memory decay, vault health scoring, knowledge graph. $25/mo on a $5 VPS.                     |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 237 \| 🐛 80 \| 🌐 TypeScript \| 📅 2026-08-16                             | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 20,978 \| 🐛 113 \| 🌐 Rust \| 📅 2026-08-17                              | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| [erpclaw](https://github.com/avansaber/erpclaw) ⭐ 91 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-16 | 47    | AI-native open-source ERP + double-entry accounting, self-hosted, run in plain English |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,448 \| 🐛 113 \| 🌐 TypeScript \| 📅 2026-08-17                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [opik-openclaw](https://github.com/comet-ml/opik-openclaw) ⭐ 718 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-07-28                                            | 50      | OpenClaw plugin for trace-level observability in Opik. See LLM spans, tool calls, sub-agent spans, usage, and cost metadata. Setup alerts and catch issues with your claw.                                                                                                                                                                                                                                    |
...
| [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 119 \| 🐛 8 \| 🌐 Rust \| 📅 2026-08-17                                                         | 32      | Local CLI/TUI for OpenClaw and coding-agent session history, with cost, token, latency, anomaly, and slow-run diagnostics.                                                                                                                                                                                                                                                                                    |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,914 \| 🐛 83 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
| [awesome-openclaw-personas](https://github.com/TravisLeeeeee/awesome-openclaw-personas) ⭐ 110 \| 🐛 2 \| 📅 2026-04-08                | NEW   | 214+ production-ready persona packages across 34 categories with complete SOUL.md, AGENTS.md, and SKILL.md configurations.                                      |
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 51,988 \| 🐛 2 \| 📅 2026-08-13                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,645 \| 🐛 509 \| 🌐 Python \| 📅 2026-08-17         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,038 \| 🐛 5 \| 🌐 Rust \| 📅 2026-08-15 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 595 \| 🐛 4 \| 🌐 Rust \| 📅 2026-08-17                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 18,891 \| 🐛 155 \| 🌐 Python \| 📅 2026-08-16                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 231,676 \| 🐛 32,494 \| 🌐 Python \| 📅 2026-08-17    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 1,942 \| 🐛 0 \| 📅 2026-08-02 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 36,321 \| 🐛 205 \| 🌐 Rust \| 📅 2026-08-17                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 36,520 \| 🐛 133 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 45 \| 🐛 25 \| 🌐 TypeScript \| 📅 2026-08-17                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| Project                                                                                                                                    | Stars | Description                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [aquaman](https://github.com/tech4242/aquaman) ⭐ 36 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-08-03                                              | -     | Credential isolation proxy — API keys never enter the agent process, injected via UDS from Keychain/1Password/Vault/keepassxc                                                                                                                                                                                             |
| [APort Agent Guardrails](https://github.com/aporthq/aport-agent-guardrails) ⭐ 25 \| 🐛 1 \| 🌐 Shell \| 📅 2026-08-10                      | -     | Pre-action authorization for OpenClaw; `before_tool_call` plugin, allowlist + 40+ blocked patterns, local or API. Setup: `npx @aporthq/agent-guardrails`                                                                                                                                                                  |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,102 \| 🐛 122 \| 🌐 TypeScript \| 📅 2026-08-15                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
