...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 48 | 🐛 3 | 📅 2026-08-17 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 961 | 🐛 2 | 📅 2026-08-20 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Release notes
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,068 | 🐛 3 | 📅 2026-08-17 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,330 | 🐛 35 | 🌐 TypeScript | 📅 2026-08-19 - Skill directory source
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 572 | 🐛 2 | 🌐 Python | 📅 2026-08-18 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 541 | 🐛 3 | 📅 2026-08-18 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`

* [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 184 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-20 - Xquik skill and API surface for X data workflows: tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Original implementation
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 184 \| 🐛 0 \| 🌐 JavaScript \| 📅 2026-08-20                                              | Xquik skill and API surface for X data workflows. Supports tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| [BuyWhere MCP](https://github.com/BuyWhere/buywhere-mcp) ⭐ 9 \| 🐛 10 \| 🌐 JavaScript \| 📅 2026-08-20                                                          | Product catalog and price comparison API for AI shopping agents. Search 200M+ products across Amazon, Lazada, Shopee, and more. Free tier, no API key required. `npm install @buywhere/mcp-server`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 386,830 | 🐛 5,807 | 🌐 TypeScript | 📅 2026-08-20 - Bug reports & features
...
| [ClawWork](https://github.com/clawwork-ai/ClawWork) ⭐ 529 \| 🐛 56 \| 🌐 TypeScript \| 📅 2026-08-19        | NEW   | Desktop & mobile workspace for OpenClaw — Electron + React 19 desktop app with parallel tasks, streaming chat, tool call cards, artifact persistence, file browser, and scheduled automation. Also available as a [PWA](https://cpwa.pages.dev) for mobile browsers (Android & iOS). Dark/light theme, 8 languages. |
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 648 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-06-30      | NEW   | Self-hosted AI agent orchestration dashboard with multi-provider support, task scheduling, and per-agent OpenClaw gateway bridging.                                                                                                                                                                                 |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,711 \| 🐛 113 \| 🌐 C \| 📅 2026-08-15                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [PhoneClaw](https://github.com/rohanarun/phoneclaw) ⭐ 563 \| 🐛 0 \| 🌐 Kotlin \| 📅 2026-08-14                      | NEW   | Automate all android phone apps                                                                                                                                                                                                                                                                                                                                      |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 240 \| 🐛 78 \| 🌐 TypeScript \| 📅 2026-08-19                             | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,125 \| 🐛 113 \| 🌐 Rust \| 📅 2026-08-20                              | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,463 \| 🐛 114 \| 🌐 TypeScript \| 📅 2026-08-20                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,918 \| 🐛 86 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,068 \| 🐛 3 \| 📅 2026-08-17                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,690 \| 🐛 518 \| 🌐 Python \| 📅 2026-08-20         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,079 \| 🐛 3 \| 🌐 Rust \| 📅 2026-08-20 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 598 \| 🐛 4 \| 🌐 Rust \| 📅 2026-08-17                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 18,913 \| 🐛 158 \| 🌐 Python \| 📅 2026-08-19                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 233,211 \| 🐛 33,659 \| 🌐 Python \| 📅 2026-08-20    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 1,956 \| 🐛 0 \| 📅 2026-08-02 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 36,392 \| 🐛 221 \| 🌐 Rust \| 📅 2026-08-19                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 36,580 \| 🐛 135 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 45 \| 🐛 28 \| 🌐 TypeScript \| 📅 2026-08-20                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,187 \| 🐛 126 \| 🌐 TypeScript \| 📅 2026-08-19                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
