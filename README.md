...
**See also:** [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 1,929 | 🐛 0 | 📅 2026-08-02 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Release notes
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 51,923 | 🐛 3 | 📅 2026-08-09 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,296 | 🐛 56 | 🌐 TypeScript | 📅 2026-08-13 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 327 | 🐛 15 | 🌐 Python | 📅 2026-08-13 - 166 curated skills for code review, testing, docs, and architecture.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 541 | 🐛 0 | 🌐 Python | 📅 2026-08-09 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 506 | 🐛 2 | 📅 2026-08-12 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`
...
* [tiny.place](https://github.com/tinyhumansai/tiny.place) ⭐ 142 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-08 - Agent-to-agent social network. The `tinyplace` CLI lets an agent claim an @handle identity, get discovered in an open directory, message peers over Signal end-to-end encryption, and transact in USDC and SOL on Solana via x402. By [TinyHumans](https://tinyhumans.ai). [ClawHub](https://clawhub.ai/tinyhumansai/tinyplace) · `clawhub install tinyplace`

* [product-manager-skills](https://github.com/Digidai/product-manager-skills) ⭐ 141 | 🐛 0 | 🌐 Shell | 📅 2026-04-12 - Senior PM agent with 6 knowledge domains, 30+ frameworks, and 32 SaaS metrics — diagnose metrics, critique PRDs, plan roadmaps, run discovery, and coach PM career transitions.

* [dev-gtm-claude-skills](https://github.com/Infrasity-Labs/dev-gtm-claude-skills) ⭐ 106 | 🐛 2 | 🌐 Python | 📅 2026-06-28 by [Infrasity-Labs](https://github.com/Infrasity-Labs) - Open-source, cross-platform agent skills for Claude Code and agentskills.io-compatible platforms. These skills are for SEO, GEO (Generative Engine Optimization), AI discoverability, and developer marketing.
...
* [LinkedIn](https://github.com/Linked-API/linkedin-skills) ⭐ 42 | 🐛 0 | 🌐 JavaScript | 📅 2026-07-21 - General-purpose LinkedIn automation via [Linked API](https://linkedapi.io) — fetch profiles, search people and companies, send messages, manage connections, create posts, and more. Supports Sales Navigator and custom workflows. [ClawHub](https://clawhub.ai/vprudnikoff/linkedapi-linkedin)
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Original implementation
...
| [BuyWhere MCP](https://github.com/BuyWhere/buywhere-mcp) ⭐ 7 \| 🐛 10 \| 🌐 JavaScript \| 📅 2026-07-30                                                          | Product catalog and price comparison API for AI shopping agents. Search 200M+ products across Amazon, Lazada, Shopee, and more. Free tier, no API key required. `npm install @buywhere/mcp-server`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 386,105 | 🐛 5,516 | 🌐 TypeScript | 📅 2026-08-13 - Bug reports & features
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 645 \| 🐛 13 \| 🌐 TypeScript \| 📅 2026-06-30      | NEW   | Self-hosted AI agent orchestration dashboard with multi-provider support, task scheduling, and per-agent OpenClaw gateway bridging.                                                                                                                                                                                 |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,651 \| 🐛 114 \| 🌐 C \| 📅 2026-08-07                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [PhoneClaw](https://github.com/rohanarun/phoneclaw) ⭐ 556 \| 🐛 0 \| 🌐 Kotlin \| 📅 2026-04-21                      | NEW   | Automate all android phone apps                                                                                                                                                                                                                                                                                                                                      |
...
| [Agent Second Brain](https://github.com/smixs/agent-second-brain) ⭐ 348 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-05                      | 152                                               | Complete second brain system: voice notes → Telegram → organized Obsidian vault + Todoist tasks + daily reports. Ebbinghaus memory decay, vault health scoring, knowledge graph. $25/mo on a $5 VPS.                     |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 236 \| 🐛 105 \| 🌐 TypeScript \| 📅 2026-08-12                            | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 20,920 \| 🐛 154 \| 🌐 Rust \| 📅 2026-08-13                              | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,432 \| 🐛 111 \| 🌐 TypeScript \| 📅 2026-08-12                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
| [crabwalk](https://github.com/monitoring/crabwalk)                                                                                                     | 683     | Real-time companion monitor for OpenClaw                                                                                                                                                                                                                                                                                                                                                                      |
| [OpenClaw Monitor](https://github.com/flik2002/openclaw-monitor) ⭐ 11 \| 🐛 0 \| 🌐 JavaScript \| 📅 2026-05-14                                        | ⭐       | Real-time AI agent monitoring dashboard — tracks Gateway status, session metrics, token usage, and message trends. Vue 3 + ECharts, self-hosted.                                                                                                                                                                                                                                                              |
| [opik-openclaw](https://github.com/comet-ml/opik-openclaw) ⭐ 713 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-07-28                                            | 50      | OpenClaw plugin for trace-level observability in Opik. See LLM spans, tool calls, sub-agent spans, usage, and cost metadata. Setup alerts and catch issues with your claw.                                                                                                                                                                                                                                    |
...
| [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 118 \| 🐛 8 \| 🌐 Rust \| 📅 2026-08-10                                                         | 32      | Local CLI/TUI for OpenClaw and coding-agent session history, with cost, token, latency, anomaly, and slow-run diagnostics.                                                                                                                                                                                                                                                                                    |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,904 \| 🐛 83 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 51,923 \| 🐛 3 \| 📅 2026-08-09                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,570 \| 🐛 509 \| 🌐 Python \| 📅 2026-08-13         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 67,984 \| 🐛 3 \| 🌐 Rust \| 📅 2026-08-08 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 576 \| 🐛 10 \| 🌐 Rust \| 📅 2026-08-12                                   | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 18,852 \| 🐛 153 \| 🌐 Python \| 📅 2026-08-12                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 229,680 \| 🐛 31,521 \| 🌐 Python \| 📅 2026-08-13    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 1,929 \| 🐛 0 \| 📅 2026-08-02 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 36,250 \| 🐛 220 \| 🌐 Rust \| 📅 2026-08-12                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 36,470 \| 🐛 130 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 42 \| 🐛 25 \| 🌐 TypeScript \| 📅 2026-08-12                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,077 \| 🐛 116 \| 🌐 TypeScript \| 📅 2026-07-31                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
| [Armorer Guard](https://github.com/ArmorerLabs/Armorer-Guard) ⭐ 41 \| 🐛 7 \| 🌐 Rust \| 📅 2026-08-09                                     | -     | Local Rust scanner and MCP proxy for AI-agent prompt injection, credential leakage, exfiltration, and risky tool-call arguments before execution.                                                                                                                                                                         |
