...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 48 | 🐛 3 | 📅 2026-08-17 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 973 | 🐛 20 | 📅 2026-08-20 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Release notes
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,104 | 🐛 3 | 📅 2026-08-20 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,331 | 🐛 40 | 🌐 TypeScript | 📅 2026-08-21 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 330 | 🐛 13 | 🌐 Python | 📅 2026-08-22 - 166 curated skills for code review, testing, docs, and architecture.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 579 | 🐛 0 | 🌐 Python | 📅 2026-08-21 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 546 | 🐛 3 | 📅 2026-08-21 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`

* [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 185 | 🐛 1 | 🌐 JavaScript | 📅 2026-08-21 - Xquik skill and API surface for X data workflows: tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.
...
* [LinkedIn](https://github.com/Linked-API/linkedin-skills) ⭐ 43 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - General-purpose LinkedIn automation via [Linked API](https://linkedapi.io) — fetch profiles, search people and companies, send messages, manage connections, create posts, and more. Supports Sales Navigator and custom workflows. [ClawHub](https://clawhub.ai/vprudnikoff/linkedapi-linkedin)
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Original implementation
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 185 \| 🐛 1 \| 🌐 JavaScript \| 📅 2026-08-21                                              | Xquik skill and API surface for X data workflows. Supports tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| [BuyWhere MCP](https://github.com/BuyWhere/buywhere-mcp) ⭐ 9 \| 🐛 10 \| 🌐 JavaScript \| 📅 2026-08-22                                                          | Product catalog and price comparison API for AI shopping agents. Search 200M+ products across Amazon, Lazada, Shopee, and more. Free tier, no API key required. `npm install @buywhere/mcp-server`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 387,067 | 🐛 6,029 | 🌐 TypeScript | 📅 2026-08-22 - Bug reports & features
...
| [lucinate](https://github.com/lucinate-ai/lucinate) ⭐ 11 \| 🐛 19 \| 🌐 Go \| 📅 2026-08-21                 | -     | Terminal-native TUI chat client for OpenClaw, Hermes, and OpenAI-compatible endpoints.                                                                                                                                                                                                                              |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,720 \| 🐛 111 \| 🌐 C \| 📅 2026-08-21                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 241 \| 🐛 97 \| 🌐 TypeScript \| 📅 2026-08-21                             | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,164 \| 🐛 101 \| 🌐 Rust \| 📅 2026-08-22                              | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,467 \| 🐛 113 \| 🌐 TypeScript \| 📅 2026-08-22                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [opik-openclaw](https://github.com/comet-ml/opik-openclaw) ⭐ 719 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-07-28                                            | 50      | OpenClaw plugin for trace-level observability in Opik. See LLM spans, tool calls, sub-agent spans, usage, and cost metadata. Setup alerts and catch issues with your claw.                                                                                                                                                                                                                                    |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,928 \| 🐛 86 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,104 \| 🐛 3 \| 📅 2026-08-20                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,739 \| 🐛 525 \| 🌐 Python \| 📅 2026-08-22         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,107 \| 🐛 4 \| 🌐 Rust \| 📅 2026-08-20 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 599 \| 🐛 3 \| 🌐 Rust \| 📅 2026-08-20                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 18,926 \| 🐛 161 \| 🌐 Python \| 📅 2026-08-19                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 234,107 \| 🐛 34,486 \| 🌐 Python \| 📅 2026-08-22    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 1,959 \| 🐛 0 \| 📅 2026-08-21 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 36,479 \| 🐛 260 \| 🌐 Rust \| 📅 2026-08-21                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 36,639 \| 🐛 135 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 46 \| 🐛 30 \| 🌐 TypeScript \| 📅 2026-08-22                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| [APort Agent Guardrails](https://github.com/aporthq/aport-agent-guardrails) ⭐ 25 \| 🐛 1 \| 🌐 Shell \| 📅 2026-08-19                      | -     | Pre-action authorization for OpenClaw; `before_tool_call` plugin, allowlist + 40+ blocked patterns, local or API. Setup: `npx @aporthq/agent-guardrails`                                                                                                                                                                  |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,350 \| 🐛 126 \| 🌐 TypeScript \| 📅 2026-08-19                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
