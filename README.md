...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 50 | 🐛 5 | 📅 2026-08-25 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 991 | 🐛 23 | 📅 2026-08-25 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Release notes
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 877 | 🐛 2 | 🌐 Python | 📅 2026-08-29 - Open source (GPL-3.0) autonomous AI pentest platform and MCP host, covering web, API, Active Directory and Kubernetes, with proof of exploitation.
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,229 | 🐛 1 | 📅 2026-08-29 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,368 | 🐛 52 | 🌐 TypeScript | 📅 2026-08-29 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 332 | 🐛 19 | 🌐 Python | 📅 2026-08-26 - 166 curated skills for code review, testing, docs, and architecture.
* [Hexis](https://github.com/Bevel-Software/Hexis) ⭐ 81 | 🐛 6 | 🌐 TypeScript | 📅 2026-08-28 - Git-backed platform for skills, tools, and context for AI agents, accessible from OpenClaw through its remote MCP server.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 613 | 🐛 3 | 🌐 Python | 📅 2026-08-25 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 580 | 🐛 3 | 📅 2026-08-25 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`
...
* [tiny.place](https://github.com/tinyhumansai/tiny.place) ⭐ 130 | 🐛 25 | 🌐 TypeScript | 📅 2026-08-08 - Agent-to-agent social network. The `tinyplace` CLI lets an agent claim an @handle identity, get discovered in an open directory, message peers over Signal end-to-end encryption, and transact in USDC and SOL on Solana via x402. By [TinyHumans](https://tinyhumans.ai). [ClawHub](https://clawhub.ai/tinyhumansai/tinyplace) · `clawhub install tinyplace`
...
* [UIZZE](https://github.com/uizze/uizze) ⭐ 13 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-29 - Portable anti-UI-slop Skill for coding agents, with a free deterministic MCP preview and UI Slop Gate grounded in 800,000+ real web and iOS screens. Install with `npx skills add https://uizze.com --skill anti-ui-slop`; it runs locally without an account or source upload.

* [0xArchive Skill](https://github.com/0xArchiveIO/0xarchive-skill) ⭐ 10 | 🐛 1 | 📅 2026-08-29 - Market-data skill for accessing Hyperliquid and Lighter data.
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Original implementation
...
| Server                                                                                                                                                           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Agent QA](https://github.com/vostride/agent-qa) ⭐ 933 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-03                                                                 | Open-source self-improving QA agent for natural-language web and mobile testing, with persistent test memory, self-healing workflows, and an MCP server available through `agent-qa mcp`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| [AI Image Generator & Editor — Nanobanana, GPT Image, ComfyUI](https://github.com/jau123/MeiGen-AI-Design-MCP) ⭐ 1,725 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-05 | Generate professional AI images through a unified interface that routes across multiple providers. 1,300+ curated prompts, style-aware prompt enhancement, and local ComfyUI workflows.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| [NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,428 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-08-29                                                           | Hosted OAuth MCP connectors for Google Ads, Meta Ads, and Google Search Console. Lets OpenClaw agents audit live account data and apply approval-gated campaign changes with change history. The public app and skills are MIT licensed; hosted connections are available at [notfair.co](https://notfair.co).                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
* [ClawBench: Can AI Agents Complete Everyday Online Tasks?](https://arxiv.org/abs/2604.08523) - Live-site web-agent benchmark with an OpenClaw harness, request-interception scoring, and five-layer run traces ([Project](https://claw-bench.com/) · [Code](https://github.com/reacher-z/ClawBench) ⭐ 603 | 🐛 60 | 🌐 Python | 📅 2026-08-22)
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 387,963 | 🐛 5,707 | 🌐 TypeScript | 📅 2026-08-29 - Bug reports & features
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,729 \| 🐛 111 \| 🌐 C \| 📅 2026-08-21                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [Agent Second Brain](https://github.com/smixs/agent-second-brain) ⭐ 359 \| 🐛 3 \| 🌐 Python \| 📅 2026-08-05                      | 152                                               | Complete second brain system: voice notes → Telegram → organized Obsidian vault + Todoist tasks + daily reports. Ebbinghaus memory decay, vault health scoring, knowledge graph. $25/mo on a $5 VPS.                     |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 243 \| 🐛 175 \| 🌐 TypeScript \| 📅 2026-08-29                            | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,288 \| 🐛 59 \| 🌐 Rust \| 📅 2026-08-29                               | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| [erpclaw](https://github.com/avansaber/erpclaw) ⭐ 98 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-16 | 47    | AI-native open-source ERP + double-entry accounting, self-hosted, run in plain English |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,484 \| 🐛 115 \| 🌐 TypeScript \| 📅 2026-08-28                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 126 \| 🐛 7 \| 🌐 Rust \| 📅 2026-08-24                                                         | 32      | Local CLI/TUI for OpenClaw and coding-agent session history, with cost, token, latency, anomaly, and slow-run diagnostics.                                                                                                                                                                                                                                                                                    |
...
| [ClawMetry](https://github.com/vivekchand/clawmetry) ⭐ 401 \| 🐛 143 \| 🌐 Python \| 📅 2026-08-29                                                     | 395     | Real-time observability dashboard for OpenClaw: live sessions, token costs, tool calls, crons, and memory, one pip install.                                                                                                                                                                                                                                                                                   |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,944 \| 🐛 89 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,229 \| 🐛 1 \| 📅 2026-08-29                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,971 \| 🐛 519 \| 🌐 Python \| 📅 2026-08-29         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,179 \| 🐛 9 \| 🌐 Rust \| 📅 2026-08-20 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 604 \| 🐛 3 \| 🌐 Rust \| 📅 2026-08-20                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 19,009 \| 🐛 141 \| 🌐 Python \| 📅 2026-08-27                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 237,939 \| 🐛 37,304 \| 🌐 Python \| 📅 2026-08-29    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 1,981 \| 🐛 0 \| 📅 2026-08-21 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 38,793 \| 🐛 326 \| 🌐 Rust \| 📅 2026-08-27                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Orkas](https://orkas.ai?source=gh_openclaw)                                                                         | Open Source | Local-first multi-agent desktop workspace; OpenClaw can run as a CLI backend alongside Claude Code, Codex, OpenCode, and Cline. [Source](https://github.com/Orkas-AI/Orkas) ⭐ 1,522 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-08-29                 |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 36,771 \| 🐛 144 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 49 \| 🐛 30 \| 🌐 TypeScript \| 📅 2026-08-29                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,425 \| 🐛 132 \| 🌐 TypeScript \| 📅 2026-08-29                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
