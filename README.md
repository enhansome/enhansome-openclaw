...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 50 | 🐛 9 | 📅 2026-08-25 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 1,001 | 🐛 47 | 📅 2026-08-25 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Release notes
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,417 | 🐛 5 | 📅 2026-09-05 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,401 | 🐛 59 | 🌐 TypeScript | 📅 2026-09-07 - Skill directory source
...
* [Hexis](https://github.com/Bevel-Software/Hexis) ⭐ 84 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-07 - Git-backed platform for skills, tools, and context for AI agents, accessible from OpenClaw through its remote MCP server.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 1,239 | 🐛 1 | 🌐 Python | 📅 2026-09-06 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 817 | 🐛 3 | 📅 2026-09-01 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Original implementation
...
| [Open Index](https://github.com/DrDroidLab/open-index) ⭐ 107 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-12                                                               | Structured context graph for domain-specific agents with hybrid search, validated read/write MCP tools, and a portable OpenClaw setup skill.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| [prompt-to-asset](https://github.com/MohamedAbdallah-14/prompt-to-asset) ⭐ 18 \| 🐛 17 \| 🌐 TypeScript \| 📅 2026-09-07                                         | MCP server and CLI that generates production-ready visual assets (app icons, favicons, OG images, logos) by routing each request across 30+ image generation models. Zero API key for first run via free-tier providers (Pollinations, Stable Horde, HuggingFace). MIT licensed.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,619 \| 🐛 13 \| 🌐 TypeScript \| 📅 2026-09-05                                                           | Hosted OAuth MCP connectors for Google Ads, Meta Ads, and Google Search Console. Lets OpenClaw agents audit live account data and apply approval-gated campaign changes with change history. The public app and skills are MIT licensed; hosted connections are available at [notfair.co](https://notfair.co).                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [RunAPI MCP](https://github.com/runapi-ai/mcp) ⭐ 55 \| 🐛 2 \| 🌐 TypeScript \| 📅 2026-09-07                                                                    | 130+ AI models for image, video, music, audio, and LLM from 18 providers. 8 MCP tools with free catalog browsing. npm: `@runapi.ai/mcp`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
* [ClawBench: Can AI Agents Complete Everyday Online Tasks?](https://arxiv.org/abs/2604.08523) - Live-site web-agent benchmark with an OpenClaw harness, request-interception scoring, and five-layer run traces ([Project](https://claw-bench.com/) · [Code](https://github.com/reacher-z/ClawBench) ⭐ 666 | 🐛 52 | 🌐 Python | 📅 2026-09-05)
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 389,097 | 🐛 6,296 | 🌐 TypeScript | 📅 2026-09-07 - Bug reports & features
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 665 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-06-30      | NEW   | Self-hosted AI agent orchestration dashboard with multi-provider support, task scheduling, and per-agent OpenClaw gateway bridging.                                                                                                                                                                                 |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,744 \| 🐛 111 \| 🌐 C \| 📅 2026-08-21                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,463 \| 🐛 59 \| 🌐 Rust \| 📅 2026-09-07                               | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,512 \| 🐛 101 \| 🌐 TypeScript \| 📅 2026-09-07                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 130 \| 🐛 7 \| 🌐 Rust \| 📅 2026-09-07                                                         | 32      | Local CLI/TUI for OpenClaw and coding-agent session history, with cost, token, latency, anomaly, and slow-run diagnostics.                                                                                                                                                                                                                                                                                    |
...
| [ClawMetry](https://github.com/vivekchand/clawmetry) ⭐ 408 \| 🐛 162 \| 🌐 Python \| 📅 2026-09-07                                                     | 395     | Real-time observability dashboard for OpenClaw: live sessions, token costs, tool calls, crons, and memory, one pip install.                                                                                                                                                                                                                                                                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,417 \| 🐛 5 \| 📅 2026-09-05                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,178 \| 🐛 587 \| 🌐 Python \| 📅 2026-09-07         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,262 \| 🐛 1 \| 🌐 Rust \| 📅 2026-09-07 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 618 \| 🐛 3 \| 🌐 Rust \| 📅 2026-08-20                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 19,113 \| 🐛 147 \| 🌐 Python \| 📅 2026-09-07                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 242,887 \| 🐛 40,552 \| 🌐 Python \| 📅 2026-09-07    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 2,003 \| 🐛 0 \| 📅 2026-08-21 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 39,491 \| 🐛 303 \| 🌐 Rust \| 📅 2026-09-07                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Orkas](https://orkas.ai?source=gh_openclaw)                                                                         | Open Source | Local-first multi-agent desktop workspace; OpenClaw can run as a CLI backend alongside Claude Code, Codex, OpenCode, and Cline. [Source](https://github.com/Orkas-AI/Orkas) ⭐ 1,785 \| 🐛 13 \| 🌐 TypeScript \| 📅 2026-09-07                 |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 37,174 \| 🐛 146 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 53 \| 🐛 32 \| 🌐 TypeScript \| 📅 2026-09-07                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| [APort Agent Guardrails](https://github.com/aporthq/aport-agent-guardrails) ⭐ 25 \| 🐛 1 \| 🌐 Shell \| 📅 2026-09-06                      | -     | Pre-action authorization for OpenClaw; `before_tool_call` plugin, allowlist + 40+ blocked patterns, local or API. Setup: `npx @aporthq/agent-guardrails`                                                                                                                                                                  |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,452 \| 🐛 139 \| 🌐 TypeScript \| 📅 2026-09-03                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
