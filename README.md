...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 1 | 🐛 0 | 📅 2026-09-23 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 1,023 | 🐛 1 | 🌐 Python | 📅 2026-09-17 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem. [awesome-meta-muse-agent](https://github.com/Anil-matcha/awesome-meta-muse-agent) ⭐ 1,034 | 🐛 2 | 🌐 Python | 📅 2026-09-24 — copy-paste Muse agent briefs for connected-app workflows and approval-aware automation.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Release notes
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,763 | 🐛 5 | 📅 2026-09-22 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,451 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-24 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 338 | 🐛 22 | 🌐 Python | 📅 2026-09-24 - 166 curated skills for code review, testing, docs, and architecture.
* [Hexis](https://github.com/Bevel-Software/Hexis) ⭐ 89 | 🐛 7 | 🌐 TypeScript | 📅 2026-09-24 - Git-backed platform for skills, tools, and context for AI agents, accessible from OpenClaw through its remote MCP server.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 3,417 | 🐛 2 | 🌐 Python | 📅 2026-09-23 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 952 | 🐛 4 | 📅 2026-09-22 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`

* [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 205 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-23 - Xquik skill and API surface for X data workflows: tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.

* [product-manager-skills](https://github.com/Digidai/product-manager-skills) ⭐ 177 | 🐛 0 | 🌐 Shell | 📅 2026-04-12 - Senior PM agent with 6 knowledge domains, 30+ frameworks, and 32 SaaS metrics — diagnose metrics, critique PRDs, plan roadmaps, run discovery, and coach PM career transitions.
...
* [dev-gtm-claude-skills](https://github.com/Infrasity-Labs/dev-gtm-claude-skills) ⭐ 126 | 🐛 0 | 🌐 Python | 📅 2026-06-28 by [Infrasity-Labs](https://github.com/Infrasity-Labs) - Open-source, cross-platform agent skills for Claude Code and agentskills.io-compatible platforms. These skills are for SEO, GEO (Generative Engine Optimization), AI discoverability, and developer marketing.

* [TweetClaw](https://github.com/Xquik-dev/tweetclaw) ⭐ 95 | 🐛 9 | 🌐 TypeScript | 📅 2026-09-22 - OpenClaw plugin for X/Twitter automation - search tweets and tweet replies, post tweets, export followers, handle media workflows, monitor accounts, send webhooks, and run giveaway draws through Xquik. `openclaw plugins install @xquik/tweetclaw`

* [Resemble Detect](https://github.com/resemble-ai/detect-skill) ⭐ 82 | 🐛 1 | 📅 2026-09-23 - Deepfake detection and media safety for OpenClaw — detect AI-generated audio, images, video, and text; identify which AI platform synthesized fake audio (source tracing); apply invisible watermarks for provenance; verify speaker identity. Powered by [Resemble AI](https://resemble.ai). Install via `openclaw skills install resemble-ai/detect-skill`.

* [LinkedIn](https://github.com/Linked-API/linkedin-skills) ⭐ 73 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - General-purpose LinkedIn automation via [Linked API](https://linkedapi.io) — fetch profiles, search people and companies, send messages, manage connections, create posts, and more. Supports Sales Navigator and custom workflows. [ClawHub](https://clawhub.ai/vprudnikoff/linkedapi-linkedin)
...
* [MediWise Health Suite](https://github.com/JuneYaooo/mediwise-health-suite) ⭐ 31 | 🐛 0 | 🌐 Python | 📅 2026-09-13 - Family health management skill — health record keeping, diet tracking, weight management, medication reminders, and medical image recognition, all with local SQLite storage for privacy.

* [UIZZE](https://github.com/uizze/uizze) ⭐ 24 | 🐛 4 | 🌐 JavaScript | 📅 2026-09-21 - Portable anti-UI-slop Skill for coding agents, with a free deterministic MCP preview and UI Slop Gate grounded in 800,000+ real web and iOS screens. Install with `npx skills add https://uizze.com --skill anti-ui-slop`; it runs locally without an account or source upload.
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Original implementation
...
| Server                                                                                                                                                           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Agent QA](https://github.com/vostride/agent-qa) ⭐ 889 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-03                                                                 | Open-source self-improving QA agent for natural-language web and mobile testing, with persistent test memory, self-healing workflows, and an MCP server available through `agent-qa mcp`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `https://api.anchorbrowser.io/mcp`                                                                                                                               | Cloud browser platform for AI agents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [Open Index](https://github.com/DrDroidLab/open-index) ⭐ 111 \| 🐛 1 \| 🌐 Python \| 📅 2026-08-12                                                               | Structured context graph for domain-specific agents with hybrid search, validated read/write MCP tools, and a portable OpenClaw setup skill.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
...
| [NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,855 \| 🐛 7 \| 🌐 TypeScript \| 📅 2026-09-24                                                            | Hosted OAuth MCP connectors for Google Ads, Meta Ads, and Google Search Console. Lets OpenClaw agents audit live account data and apply approval-gated campaign changes with change history. The public app and skills are MIT licensed; hosted connections are available at [notfair.co](https://notfair.co).                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 205 \| 🐛 3 \| 🌐 JavaScript \| 📅 2026-09-23                                              | Xquik skill and API surface for X data workflows. Supports tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [RunAPI MCP](https://github.com/runapi-ai/mcp) ⭐ 55 \| 🐛 10 \| 🌐 TypeScript \| 📅 2026-09-22                                                                   | 130+ AI models for image, video, music, audio, and LLM from 18 providers. 8 MCP tools with free catalog browsing. npm: `@runapi.ai/mcp`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
* [ClawBench: Can AI Agents Complete Everyday Online Tasks?](https://arxiv.org/abs/2604.08523) - Live-site web-agent benchmark with an OpenClaw harness, request-interception scoring, and five-layer run traces ([Project](https://claw-bench.com/) · [Code](https://github.com/reacher-z/ClawBench) ⭐ 840 | 🐛 51 | 🌐 Python | 📅 2026-09-20)
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 390,377 | 🐛 8,497 | 🌐 TypeScript | 📅 2026-09-24 - Bug reports & features
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,767 \| 🐛 111 \| 🌐 C \| 📅 2026-08-21                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 294 \| 🐛 223 \| 🌐 TypeScript \| 📅 2026-09-22                            | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,683 \| 🐛 33 \| 🌐 Rust \| 📅 2026-09-24                               | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| [erpclaw](https://github.com/avansaber/erpclaw) ⭐ 107 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-13 | 47    | AI-native open-source ERP + double-entry accounting, self-hosted, run in plain English |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,541 \| 🐛 110 \| 🌐 TypeScript \| 📅 2026-09-24                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [ClawMetry](https://github.com/vivekchand/clawmetry) ⭐ 421 \| 🐛 63 \| 🌐 Python \| 📅 2026-09-24                                                      | 395     | Real-time observability dashboard for OpenClaw: live sessions, token costs, tool calls, crons, and memory, one pip install.                                                                                                                                                                                                                                                                                   |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,984 \| 🐛 89 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,763 \| 🐛 5 \| 📅 2026-09-22                     | -     | Community curated skills collection                                                                                                                             |
...
| [ByeByeClaw](https://github.com/wanikua/byebyeclaw) ⭐ 75 \| 🐛 1 \| 🌐 Shell \| 📅 2026-03-15                                         | NEW   | One-command uninstaller for all Claw-family AI agents (OpenClaw, ZeroClaw, NanoClaw, etc.). 15 scan dimensions, zero residue, cross-platform, bilingual (EN/中文) |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,519 \| 🐛 538 \| 🌐 Python \| 📅 2026-09-24         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,427 \| 🐛 2 \| 🌐 Rust \| 📅 2026-09-23 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 642 \| 🐛 5 \| 🌐 Rust \| 📅 2026-09-13                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 19,255 \| 🐛 141 \| 🌐 Python \| 📅 2026-09-23                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 248,574 \| 🐛 43,547 \| 🌐 Python \| 📅 2026-09-24    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 2,038 \| 🐛 0 \| 📅 2026-08-21 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 40,088 \| 🐛 252 \| 🌐 Rust \| 📅 2026-09-24                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Orkas](https://orkas.ai?source=gh_openclaw)                                                                         | Open Source | Local-first multi-agent desktop workspace; OpenClaw can run as a CLI backend alongside Claude Code, Codex, OpenCode, and Cline. [Source](https://github.com/Orkas-AI/Orkas) ⭐ 2,117 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-09-24                 |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 37,488 \| 🐛 152 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 63 \| 🐛 23 \| 🌐 TypeScript \| 📅 2026-09-24                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| Project                                                                                                                                    | Stars | Description                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [aquaman](https://github.com/tech4242/aquaman) ⭐ 37 \| 🐛 2 \| 🌐 TypeScript \| 📅 2026-09-23                                              | -     | Credential isolation proxy — API keys never enter the agent process, injected via UDS from Keychain/1Password/Vault/keepassxc                                                                                                                                                                                             |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,512 \| 🐛 162 \| 🌐 TypeScript \| 📅 2026-09-14                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
| [Armorer Guard](https://github.com/ArmorerLabs/Armorer-Guard) ⭐ 42 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-03                                   | -     | Local Rust scanner and MCP proxy for AI-agent prompt injection, credential leakage, exfiltration, and risky tool-call arguments before execution.                                                                                                                                                                         |
