...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 52 | 🐛 10 | 📅 2026-08-25 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 1,013 | 🐛 0 | 🌐 Python | 📅 2026-09-17 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Release notes
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,639 | 🐛 2 | 📅 2026-09-14 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,425 | 🐛 74 | 🌐 TypeScript | 📅 2026-09-18 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 336 | 🐛 21 | 🌐 Python | 📅 2026-09-17 - 166 curated skills for code review, testing, docs, and architecture.
* [Hexis](https://github.com/Bevel-Software/Hexis) ⭐ 88 | 🐛 21 | 🌐 TypeScript | 📅 2026-09-18 - Git-backed platform for skills, tools, and context for AI agents, accessible from OpenClaw through its remote MCP server.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 2,699 | 🐛 1 | 🌐 Python | 📅 2026-09-18 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 881 | 🐛 4 | 📅 2026-09-15 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`

* [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 199 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-18 - Xquik skill and API surface for X data workflows: tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.
...
* [LinkedIn](https://github.com/Linked-API/linkedin-skills) ⭐ 59 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-13 - General-purpose LinkedIn automation via [Linked API](https://linkedapi.io) — fetch profiles, search people and companies, send messages, manage connections, create posts, and more. Supports Sales Navigator and custom workflows. [ClawHub](https://clawhub.ai/vprudnikoff/linkedapi-linkedin)
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Original implementation
...
| Server                                                                                                                                                           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Agent QA](https://github.com/vostride/agent-qa) ⭐ 910 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-03                                                                 | Open-source self-improving QA agent for natural-language web and mobile testing, with persistent test memory, self-healing workflows, and an MCP server available through `agent-qa mcp`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| [AI Image Generator & Editor — Nanobanana, GPT Image, ComfyUI](https://github.com/jau123/MeiGen-AI-Design-MCP) ⭐ 1,766 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-09-17 | Generate professional AI images through a unified interface that routes across multiple providers. 1,300+ curated prompts, style-aware prompt enhancement, and local ComfyUI workflows.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| [NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,820 \| 🐛 11 \| 🌐 TypeScript \| 📅 2026-09-17                                                           | Hosted OAuth MCP connectors for Google Ads, Meta Ads, and Google Search Console. Lets OpenClaw agents audit live account data and apply approval-gated campaign changes with change history. The public app and skills are MIT licensed; hosted connections are available at [notfair.co](https://notfair.co).                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 199 \| 🐛 3 \| 🌐 JavaScript \| 📅 2026-09-18                                              | Xquik skill and API surface for X data workflows. Supports tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| [BuyWhere MCP](https://github.com/BuyWhere/buywhere-mcp) ⭐ 12 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-09-17                                                         | Product catalog and price comparison API for AI shopping agents. Search 200M+ products across Amazon, Lazada, Shopee, and more. Free tier, no API key required. `npm install @buywhere/mcp-server`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [ClawBench: Can AI Agents Complete Everyday Online Tasks?](https://arxiv.org/abs/2604.08523) - Live-site web-agent benchmark with an OpenClaw harness, request-interception scoring, and five-layer run traces ([Project](https://claw-bench.com/) · [Code](https://github.com/reacher-z/ClawBench) ⭐ 778 | 🐛 47 | 🌐 Python | 📅 2026-09-15)
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 390,027 | 🐛 7,787 | 🌐 TypeScript | 📅 2026-09-18 - Bug reports & features
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 674 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-06-30      | NEW   | Self-hosted AI agent orchestration dashboard with multi-provider support, task scheduling, and per-agent OpenClaw gateway bridging.                                                                                                                                                                                 |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,754 \| 🐛 111 \| 🌐 C \| 📅 2026-08-21                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 291 \| 🐛 211 \| 🌐 TypeScript \| 📅 2026-09-18                            | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,619 \| 🐛 29 \| 🌐 TypeScript \| 📅 2026-09-18                         | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| [erpclaw](https://github.com/avansaber/erpclaw) ⭐ 103 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-13 | 47    | AI-native open-source ERP + double-entry accounting, self-hosted, run in plain English |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,528 \| 🐛 107 \| 🌐 TypeScript \| 📅 2026-09-17                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [Claw Lens](https://github.com/msfirebird/claw-lens) ⭐ 376 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-04-15                                                   | NEW     | Open-source local dashboard for OpenClaw — cost analytics, live monitoring, session inspection, profiler, cache trace, and security audit.                                                                                                                                                                                                                                                                    |
...
| [ClawMetry](https://github.com/vivekchand/clawmetry) ⭐ 416 \| 🐛 63 \| 🌐 Python \| 📅 2026-09-18                                                      | 395     | Real-time observability dashboard for OpenClaw: live sessions, token costs, tool calls, crons, and memory, one pip install.                                                                                                                                                                                                                                                                                   |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,966 \| 🐛 89 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,639 \| 🐛 2 \| 📅 2026-09-14                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,425 \| 🐛 595 \| 🌐 Python \| 📅 2026-09-18         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,378 \| 🐛 3 \| 🌐 Rust \| 📅 2026-09-15 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 19,199 \| 🐛 142 \| 🌐 Python \| 📅 2026-09-18                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 246,741 \| 🐛 44,138 \| 🌐 Python \| 📅 2026-09-18    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 2,020 \| 🐛 0 \| 📅 2026-08-21 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 39,869 \| 🐛 201 \| 🌐 Rust \| 📅 2026-09-17                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Orkas](https://orkas.ai?source=gh_openclaw)                                                                         | Open Source | Local-first multi-agent desktop workspace; OpenClaw can run as a CLI backend alongside Claude Code, Codex, OpenCode, and Cline. [Source](https://github.com/Orkas-AI/Orkas) ⭐ 2,043 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-09-18                 |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 37,399 \| 🐛 150 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 59 \| 🐛 7 \| 🌐 TypeScript \| 📅 2026-09-18                    | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,495 \| 🐛 154 \| 🌐 TypeScript \| 📅 2026-09-14                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
