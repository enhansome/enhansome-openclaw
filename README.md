...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 46 | 🐛 3 | 📅 2026-08-17 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 943 | 🐛 8 | 📅 2026-08-18 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Release notes
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,042 | 🐛 1 | 📅 2026-08-17 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,327 | 🐛 37 | 🌐 TypeScript | 📅 2026-08-19 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 329 | 🐛 13 | 🌐 Python | 📅 2026-08-16 - 166 curated skills for code review, testing, docs, and architecture.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 567 | 🐛 2 | 🌐 Python | 📅 2026-08-18 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 535 | 🐛 3 | 📅 2026-08-18 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`

* [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 183 | 🐛 0 | 🌐 JavaScript | 📅 2026-08-18 - Xquik skill and API surface for X data workflows: tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.

* [product-manager-skills](https://github.com/Digidai/product-manager-skills) ⭐ 147 | 🐛 0 | 🌐 Shell | 📅 2026-04-12 - Senior PM agent with 6 knowledge domains, 30+ frameworks, and 32 SaaS metrics — diagnose metrics, critique PRDs, plan roadmaps, run discovery, and coach PM career transitions.

* [tiny.place](https://github.com/tinyhumansai/tiny.place) ⭐ 126 | 🐛 24 | 🌐 TypeScript | 📅 2026-08-08 - Agent-to-agent social network. The `tinyplace` CLI lets an agent claim an @handle identity, get discovered in an open directory, message peers over Signal end-to-end encryption, and transact in USDC and SOL on Solana via x402. By [TinyHumans](https://tinyhumans.ai). [ClawHub](https://clawhub.ai/tinyhumansai/tinyplace) · `clawhub install tinyplace`

* [dev-gtm-claude-skills](https://github.com/Infrasity-Labs/dev-gtm-claude-skills) ⭐ 111 | 🐛 2 | 🌐 Python | 📅 2026-06-28 by [Infrasity-Labs](https://github.com/Infrasity-Labs) - Open-source, cross-platform agent skills for Claude Code and agentskills.io-compatible platforms. These skills are for SEO, GEO (Generative Engine Optimization), AI discoverability, and developer marketing.

* [TweetClaw](https://github.com/Xquik-dev/tweetclaw) ⭐ 92 | 🐛 1 | 🌐 TypeScript | 📅 2026-08-18 - OpenClaw plugin for X/Twitter automation - search tweets and tweet replies, post tweets, export followers, handle media workflows, monitor accounts, send webhooks, and run giveaway draws through Xquik. `openclaw plugins install @xquik/tweetclaw`

* [Resemble Detect](https://github.com/resemble-ai/detect-skill) ⭐ 55 | 🐛 1 | 📅 2026-08-17 - Deepfake detection and media safety for OpenClaw — detect AI-generated audio, images, video, and text; identify which AI platform synthesized fake audio (source tracing); apply invisible watermarks for provenance; verify speaker identity. Powered by [Resemble AI](https://resemble.ai). Install via `openclaw skills install resemble-ai/detect-skill`.
...
* [News API](https://github.com/currentslab/news-api-skills) ⭐ 2 | 🐛 1 | 🌐 Shell | 📅 2026-07-12 - Install-ready `news-api` skill for OpenClaw and other agent runtimes, enabling secure latest-news and search across workflows.
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Original implementation
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 183 \| 🐛 0 \| 🌐 JavaScript \| 📅 2026-08-18                                              | Xquik skill and API surface for X data workflows. Supports tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [RunAPI MCP](https://github.com/runapi-ai/mcp) ⭐ 55 \| 🐛 1 \| 🌐 TypeScript \| 📅 2026-08-17                                                                    | 130+ AI models for image, video, music, audio, and LLM from 18 providers. 8 MCP tools with free catalog browsing. npm: `@runapi.ai/mcp`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| [BuyWhere MCP](https://github.com/BuyWhere/buywhere-mcp) ⭐ 9 \| 🐛 10 \| 🌐 JavaScript \| 📅 2026-08-19                                                          | Product catalog and price comparison API for AI shopping agents. Search 200M+ products across Amazon, Lazada, Shopee, and more. Free tier, no API key required. `npm install @buywhere/mcp-server`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 386,713 | 🐛 5,765 | 🌐 TypeScript | 📅 2026-08-19 - Bug reports & features
...
| [Nerve](https://github.com/daggerhashimoto/openclaw-nerve) ⭐ 863 \| 🐛 40 \| 🌐 TypeScript \| 📅 2026-06-03 | NEW   | Self-hosted web cockpit for OpenClaw — real-time streaming with reasoning blocks, voice I/O (local STT/TTS), sub-agent session monitoring, cron job management, memory editor, inline TradingView/Recharts, code editor, model selector. One-command install. [Website](https://nerve.zone)                         |
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 648 \| 🐛 13 \| 🌐 TypeScript \| 📅 2026-06-30      | NEW   | Self-hosted AI agent orchestration dashboard with multi-provider support, task scheduling, and per-agent OpenClaw gateway bridging.                                                                                                                                                                                 |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,708 \| 🐛 113 \| 🌐 C \| 📅 2026-08-15                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [Agent Second Brain](https://github.com/smixs/agent-second-brain) ⭐ 353 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-05                      | 152                                               | Complete second brain system: voice notes → Telegram → organized Obsidian vault + Todoist tasks + daily reports. Ebbinghaus memory decay, vault health scoring, knowledge graph. $25/mo on a $5 VPS.                     |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 240 \| 🐛 74 \| 🌐 TypeScript \| 📅 2026-08-18                             | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,096 \| 🐛 114 \| 🌐 Rust \| 📅 2026-08-19                              | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| [erpclaw](https://github.com/avansaber/erpclaw) ⭐ 92 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-16 | 47    | AI-native open-source ERP + double-entry accounting, self-hosted, run in plain English |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,457 \| 🐛 112 \| 🌐 TypeScript \| 📅 2026-08-18                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 121 \| 🐛 8 \| 🌐 Rust \| 📅 2026-08-17                                                         | 32      | Local CLI/TUI for OpenClaw and coding-agent session history, with cost, token, latency, anomaly, and slow-run diagnostics.                                                                                                                                                                                                                                                                                    |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,915 \| 🐛 85 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,042 \| 🐛 1 \| 📅 2026-08-17                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 186,683 \| 🐛 507 \| 🌐 Python \| 📅 2026-08-19         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,065 \| 🐛 3 \| 🌐 Rust \| 📅 2026-08-18 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 596 \| 🐛 4 \| 🌐 Rust \| 📅 2026-08-17                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 18,907 \| 🐛 156 \| 🌐 Python \| 📅 2026-08-16                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 232,706 \| 🐛 33,380 \| 🌐 Python \| 📅 2026-08-19    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 1,954 \| 🐛 0 \| 📅 2026-08-02 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 36,373 \| 🐛 209 \| 🌐 Rust \| 📅 2026-08-18                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 36,554 \| 🐛 134 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 45 \| 🐛 25 \| 🌐 TypeScript \| 📅 2026-08-19                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| Project                                                                                                                                    | Stars | Description                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [aquaman](https://github.com/tech4242/aquaman) ⭐ 36 \| 🐛 3 \| 🌐 TypeScript \| 📅 2026-08-17                                              | -     | Credential isolation proxy — API keys never enter the agent process, injected via UDS from Keychain/1Password/Vault/keepassxc                                                                                                                                                                                             |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,112 \| 🐛 122 \| 🌐 TypeScript \| 📅 2026-08-18                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
