...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 51 | 🐛 9 | 📅 2026-08-25 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 1,005 | 🐛 52 | 📅 2026-08-25 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Release notes
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 918 | 🐛 3 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI pentest platform and MCP host, covering web, API, Active Directory and Kubernetes, with proof of exploitation.
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,510 | 🐛 6 | 📅 2026-09-05 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,413 | 🐛 88 | 🌐 TypeScript | 📅 2026-09-11 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 337 | 🐛 21 | 🌐 Python | 📅 2026-09-10 - 166 curated skills for code review, testing, docs, and architecture.
* [Hexis](https://github.com/Bevel-Software/Hexis) ⭐ 87 | 🐛 4 | 🌐 TypeScript | 📅 2026-09-11 - Git-backed platform for skills, tools, and context for AI agents, accessible from OpenClaw through its remote MCP server.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 1,898 | 🐛 3 | 🌐 Python | 📅 2026-09-09 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 848 | 🐛 4 | 📅 2026-09-08 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`

* [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 196 | 🐛 2 | 🌐 JavaScript | 📅 2026-09-04 - Xquik skill and API surface for X data workflows: tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.

* [product-manager-skills](https://github.com/Digidai/product-manager-skills) ⭐ 162 | 🐛 0 | 🌐 Shell | 📅 2026-04-12 - Senior PM agent with 6 knowledge domains, 30+ frameworks, and 32 SaaS metrics — diagnose metrics, critique PRDs, plan roadmaps, run discovery, and coach PM career transitions.
...
* [MediWise Health Suite](https://github.com/JuneYaooo/mediwise-health-suite) ⭐ 29 | 🐛 0 | 🌐 Python | 📅 2026-09-11 - Family health management skill — health record keeping, diet tracking, weight management, medication reminders, and medical image recognition, all with local SQLite storage for privacy.

* [UIZZE](https://github.com/uizze/uizze) ⭐ 19 | 🐛 5 | 🌐 JavaScript | 📅 2026-09-11 - Portable anti-UI-slop Skill for coding agents, with a free deterministic MCP preview and UI Slop Gate grounded in 800,000+ real web and iOS screens. Install with `npx skills add https://uizze.com --skill anti-ui-slop`; it runs locally without an account or source upload.
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Original implementation
...
| Server                                                                                                                                                           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Agent QA](https://github.com/vostride/agent-qa) ⭐ 907 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-03                                                                 | Open-source self-improving QA agent for natural-language web and mobile testing, with persistent test memory, self-healing workflows, and an MCP server available through `agent-qa mcp`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
...
| [AI Image Generator & Editor — Nanobanana, GPT Image, ComfyUI](https://github.com/jau123/MeiGen-AI-Design-MCP) ⭐ 1,749 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-05 | Generate professional AI images through a unified interface that routes across multiple providers. 1,300+ curated prompts, style-aware prompt enhancement, and local ComfyUI workflows.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| [prompt-to-asset](https://github.com/MohamedAbdallah-14/prompt-to-asset) ⭐ 19 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-09-11                                         | MCP server and CLI that generates production-ready visual assets (app icons, favicons, OG images, logos) by routing each request across 30+ image generation models. Zero API key for first run via free-tier providers (Pollinations, Stable Horde, HuggingFace). MIT licensed.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,753 \| 🐛 15 \| 🌐 TypeScript \| 📅 2026-09-11                                                           | Hosted OAuth MCP connectors for Google Ads, Meta Ads, and Google Search Console. Lets OpenClaw agents audit live account data and apply approval-gated campaign changes with change history. The public app and skills are MIT licensed; hosted connections are available at [notfair.co](https://notfair.co).                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 196 \| 🐛 2 \| 🌐 JavaScript \| 📅 2026-09-04                                              | Xquik skill and API surface for X data workflows. Supports tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [RunAPI MCP](https://github.com/runapi-ai/mcp) ⭐ 55 \| 🐛 2 \| 🌐 TypeScript \| 📅 2026-09-11                                                                    | 130+ AI models for image, video, music, audio, and LLM from 18 providers. 8 MCP tools with free catalog browsing. npm: `@runapi.ai/mcp`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| [BuyWhere MCP](https://github.com/BuyWhere/buywhere-mcp) ⭐ 12 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-09-04                                                         | Product catalog and price comparison API for AI shopping agents. Search 200M+ products across Amazon, Lazada, Shopee, and more. Free tier, no API key required. `npm install @buywhere/mcp-server`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [ClawBench: Can AI Agents Complete Everyday Online Tasks?](https://arxiv.org/abs/2604.08523) - Live-site web-agent benchmark with an OpenClaw harness, request-interception scoring, and five-layer run traces ([Project](https://claw-bench.com/) · [Code](https://github.com/reacher-z/ClawBench) ⭐ 718 | 🐛 28 | 🌐 Python | 📅 2026-09-10)
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 389,491 | 🐛 6,944 | 🌐 TypeScript | 📅 2026-09-12 - Bug reports & features
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 670 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-06-30      | NEW   | Self-hosted AI agent orchestration dashboard with multi-provider support, task scheduling, and per-agent OpenClaw gateway bridging.                                                                                                                                                                                 |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,746 \| 🐛 111 \| 🌐 C \| 📅 2026-08-21                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 268 \| 🐛 201 \| 🌐 TypeScript \| 📅 2026-09-11                            | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,545 \| 🐛 33 \| 🌐 Rust \| 📅 2026-09-12                               | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,520 \| 🐛 103 \| 🌐 TypeScript \| 📅 2026-09-11                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 131 \| 🐛 7 \| 🌐 Rust \| 📅 2026-09-11                                                         | 32      | Local CLI/TUI for OpenClaw and coding-agent session history, with cost, token, latency, anomaly, and slow-run diagnostics.                                                                                                                                                                                                                                                                                    |
...
| [ClawMetry](https://github.com/vivekchand/clawmetry) ⭐ 414 \| 🐛 56 \| 🌐 Python \| 📅 2026-09-12                                                      | 395     | Real-time observability dashboard for OpenClaw: live sessions, token costs, tool calls, crons, and memory, one pip install.                                                                                                                                                                                                                                                                                   |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,960 \| 🐛 89 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,510 \| 🐛 6 \| 📅 2026-09-05                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,278 \| 🐛 565 \| 🌐 Python \| 📅 2026-09-12         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,300 \| 🐛 3 \| 🌐 Rust \| 📅 2026-09-09 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 625 \| 🐛 1 \| 🌐 Rust \| 📅 2026-09-12                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 19,143 \| 🐛 147 \| 🌐 Python \| 📅 2026-09-09                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 244,759 \| 🐛 42,292 \| 🌐 Python \| 📅 2026-09-12    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 2,012 \| 🐛 0 \| 📅 2026-08-21 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 39,687 \| 🐛 205 \| 🌐 Rust \| 📅 2026-09-12                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Orkas](https://orkas.ai?source=gh_openclaw)                                                                         | Open Source | Local-first multi-agent desktop workspace; OpenClaw can run as a CLI backend alongside Claude Code, Codex, OpenCode, and Cline. [Source](https://github.com/Orkas-AI/Orkas) ⭐ 1,927 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-09-12                 |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 37,283 \| 🐛 150 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 55 \| 🐛 32 \| 🌐 TypeScript \| 📅 2026-09-12                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,468 \| 🐛 150 \| 🌐 TypeScript \| 📅 2026-09-10                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
