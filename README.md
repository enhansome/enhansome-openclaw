...
**See also:** [awesome-hermes-agent](https://github.com/Anil-matcha/awesome-hermes-agent) ⭐ 51 | 🐛 9 | 📅 2026-08-25 — curated resources for Hermes Agent (Nous Research), the most common upgrade path from OpenClaw with a native `hermes claw migrate` command. [awesome-deepseek-harness](https://github.com/Anil-matcha/awesome-deepseek-harness) ⭐ 1,011 | 🐛 60 | 📅 2026-08-25 — curated resources for DeepSeek Harness (`dsh`), another everything-is-a-plugin agent with a large community plugin ecosystem.

[![GitHub stars](https://img.shields.io/github/stars/openclaw/openclaw?style=social)](https://github.com/openclaw/openclaw) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16
...
* [OpenClaw GitHub](https://github.com/openclaw/openclaw) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Main repository (150k+ stars)
* [OpenClaw Releases](https://github.com/openclaw/openclaw/releases) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Latest releases
* [AGENTS.md](https://github.com/openclaw/openclaw/blob/main/AGENTS.md) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Agent configuration guide
* [CHANGELOG.md](https://github.com/openclaw/openclaw/blob/main/CHANGELOG.md) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Release notes
* [Darkmoon](https://github.com/ASCIT31/Dark-Moon) ⭐ 940 | 🐛 2 | 🌐 Python | 📅 2026-09-08 - Open source (GPL-3.0) autonomous AI pentest platform and MCP host, covering web, API, Active Directory and Kubernetes, with proof of exploitation.
...
* [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,607 | 🐛 0 | 📅 2026-09-14 - Community curated collection
* [openclaw/clawhub](https://github.com/openclaw/clawhub) ⭐ 9,428 | 🐛 61 | 🌐 TypeScript | 📅 2026-09-16 - Skill directory source
* [night-market](https://github.com/athola/claude-night-market) ⭐ 337 | 🐛 21 | 🌐 Python | 📅 2026-09-14 - 166 curated skills for code review, testing, docs, and architecture.
* [Hexis](https://github.com/Bevel-Software/Hexis) ⭐ 88 | 🐛 6 | 🌐 TypeScript | 📅 2026-09-16 - Git-backed platform for skills, tools, and context for AI agents, accessible from OpenClaw through its remote MCP server.
* [AgentFund](https://github.com/RioTheGreat-ai/agentfund-skill) ⭐ 12 | 🐛 0 | 🌐 Shell | 📅 2026-02-03 - Crowdfunding platform for AI agents (milestone-based escrow on Base)
...
* [LinkedIn Skills](https://github.com/sergebulaev/linkedin-skills) ⭐ 2,534 | 🐛 1 | 🌐 Python | 📅 2026-09-15 - 10 MIT-licensed skills for LinkedIn content and engagement: post writer with 16 tested hook formulas, humanizer that strips AI tells, pre-publish audit, comment drafter, reply handler, hook extractor, content planner, profile optimizer, engager analytics, and thread monitor. Focused on writing in your own voice rather than API automation. All 10 skills on [ClawHub](https://clawhub.ai/sergebulaev); also runs in Claude Code and Codex. `clawhub install linkedin-post-writer`

* [youtube-full](https://github.com/ZeroPointRepo/youtube-skills) ⭐ 875 | 🐛 4 | 📅 2026-09-15 - YouTube transcripts, video/channel search, channel browsing, and playlist extraction via TranscriptAPI. No yt-dlp, works from any cloud server. `npx skills add ZeroPointRepo/youtube-skills --skill youtube-full`

* [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 199 | 🐛 3 | 🌐 JavaScript | 📅 2026-09-04 - Xquik skill and API surface for X data workflows: tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.

* [product-manager-skills](https://github.com/Digidai/product-manager-skills) ⭐ 164 | 🐛 0 | 🌐 Shell | 📅 2026-04-12 - Senior PM agent with 6 knowledge domains, 30+ frameworks, and 32 SaaS metrics — diagnose metrics, critique PRDs, plan roadmaps, run discovery, and coach PM career transitions.

* [tiny.place](https://github.com/tinyhumansai/tiny.place) ⭐ 133 | 🐛 26 | 🌐 TypeScript | 📅 2026-08-08 - Agent-to-agent social network. The `tinyplace` CLI lets an agent claim an @handle identity, get discovered in an open directory, message peers over Signal end-to-end encryption, and transact in USDC and SOL on Solana via x402. By [TinyHumans](https://tinyhumans.ai). [ClawHub](https://clawhub.ai/tinyhumansai/tinyplace) · `clawhub install tinyplace`
...
* [MediWise Health Suite](https://github.com/JuneYaooo/mediwise-health-suite) ⭐ 29 | 🐛 0 | 🌐 Python | 📅 2026-09-13 - Family health management skill — health record keeping, diet tracking, weight management, medication reminders, and medical image recognition, all with local SQLite storage for privacy.

* [UIZZE](https://github.com/uizze/uizze) ⭐ 20 | 🐛 6 | 🌐 JavaScript | 📅 2026-09-11 - Portable anti-UI-slop Skill for coding agents, with a free deterministic MCP preview and UI Slop Gate grounded in 800,000+ real web and iOS screens. Install with `npx skills add https://uizze.com --skill anti-ui-slop`; it runs locally without an account or source upload.
...
* [AI Router Provider](https://github.com/airouter-dev/openclaw-ai-router) ⭐ 0 | 🐛 2 | 🌐 TypeScript | 📅 2026-09-13 - OpenAI-compatible OpenClaw provider plugin for [AI Router](https://ai-router.dev), with authenticated model discovery and manual fallback. [ClawHub](https://clawhub.ai/airouter-dev/plugins/openclaw-ai-router).
...
* [Native MCP Support Issue](https://github.com/openclaw/openclaw/issues/4834) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Feature discussion
* [MCP Server PR #5121](https://github.com/openclaw/openclaw/pull/5121) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Server support implementation
* [MCP Server PR #1605](https://github.com/openclaw/openclaw/pull/1605) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Original implementation
...
| Server                                                                                                                                                           | Description                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                    |
| ---------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Agent QA](https://github.com/vostride/agent-qa) ⭐ 911 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-08-03                                                                 | Open-source self-improving QA agent for natural-language web and mobile testing, with persistent test memory, self-healing workflows, and an MCP server available through `agent-qa mcp`.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                      |
| `https://api.anchorbrowser.io/mcp`                                                                                                                               | Cloud browser platform for AI agents                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
| [Open Index](https://github.com/DrDroidLab/open-index) ⭐ 109 \| 🐛 0 \| 🌐 Python \| 📅 2026-08-12                                                               | Structured context graph for domain-specific agents with hybrid search, validated read/write MCP tools, and a portable OpenClaw setup skill.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                   |
| [AI Image Generator & Editor — Nanobanana, GPT Image, ComfyUI](https://github.com/jau123/MeiGen-AI-Design-MCP) ⭐ 1,764 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-09-15 | Generate professional AI images through a unified interface that routes across multiple providers. 1,300+ curated prompts, style-aware prompt enhancement, and local ComfyUI workflows.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                        |
...
| [prompt-to-asset](https://github.com/MohamedAbdallah-14/prompt-to-asset) ⭐ 19 \| 🐛 20 \| 🌐 TypeScript \| 📅 2026-09-15                                         | MCP server and CLI that generates production-ready visual assets (app icons, favicons, OG images, logos) by routing each request across 30+ image generation models. Zero API key for first run via free-tier providers (Pollinations, Stable Horde, HuggingFace). MIT licensed.                                                                                                                                                                                                                                                                                                                                                                                                                                                               |
| [NotFair](https://github.com/nowork-studio/NotFair) ⭐ 3,805 \| 🐛 16 \| 🌐 TypeScript \| 📅 2026-09-11                                                           | Hosted OAuth MCP connectors for Google Ads, Meta Ads, and Google Search Console. Lets OpenClaw agents audit live account data and apply approval-gated campaign changes with change history. The public app and skills are MIT licensed; hosted connections are available at [notfair.co](https://notfair.co).                                                                                                                                                                                                                                                                                                                                                                                                                                 |
...
| [x-twitter-scraper](https://github.com/Xquik-dev/x-twitter-scraper) ⭐ 199 \| 🐛 3 \| 🌐 JavaScript \| 📅 2026-09-04                                              | Xquik skill and API surface for X data workflows. Supports tweet search, user lookup, follower/following exports, engagement metrics, account monitoring, extraction jobs, REST API, MCP server, SDKs, and webhooks.                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                           |
...
| [BuyWhere MCP](https://github.com/BuyWhere/buywhere-mcp) ⭐ 12 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-09-15                                                         | Product catalog and price comparison API for AI shopping agents. Search 200M+ products across Amazon, Lazada, Shopee, and more. Free tier, no API key required. `npm install @buywhere/mcp-server`                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                                             |
...
* [ClawBench: Can AI Agents Complete Everyday Online Tasks?](https://arxiv.org/abs/2604.08523) - Live-site web-agent benchmark with an OpenClaw harness, request-interception scoring, and five-layer run traces ([Project](https://claw-bench.com/) · [Code](https://github.com/reacher-z/ClawBench) ⭐ 761 | 🐛 46 | 🌐 Python | 📅 2026-09-15)
...
* [GitHub Discussions](https://github.com/openclaw/openclaw/discussions) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Community forum
* [GitHub Issues](https://github.com/openclaw/openclaw/issues) ⭐ 389,831 | 🐛 7,432 | 🌐 TypeScript | 📅 2026-09-16 - Bug reports & features
...
| [lucinate](https://github.com/lucinate-ai/lucinate) ⭐ 11 \| 🐛 18 \| 🌐 Go \| 📅 2026-09-13                 | -     | Terminal-native TUI chat client for OpenClaw, Hermes, and OpenAI-compatible endpoints.                                                                                                                                                                                                                              |
...
| [SwarmClaw](https://github.com/swarmclawai/swarmclaw) ⭐ 672 \| 🐛 18 \| 🌐 TypeScript \| 📅 2026-06-30      | NEW   | Self-hosted AI agent orchestration dashboard with multi-provider support, task scheduling, and per-agent OpenClaw gateway bridging.                                                                                                                                                                                 |
...
| [MimiClaw](https://github.com/memovai/mimiclaw) ⭐ 5,751 \| 🐛 111 \| 🌐 C \| 📅 2026-08-21                           | NEW   | Run OpenClaw on a $5 ESP32-S3 chip without Linux or Node.js                                                                                                                                                                                                                                                                                                          |
...
| [Agent Second Brain](https://github.com/smixs/agent-second-brain) ⭐ 368 \| 🐛 2 \| 🌐 Python \| 📅 2026-08-05                      | 152                                               | Complete second brain system: voice notes → Telegram → organized Obsidian vault + Todoist tasks + daily reports. Ebbinghaus memory decay, vault health scoring, knowledge graph. $25/mo on a $5 VPS.                     |
...
| [PLUR Memory Engine](https://github.com/plur-ai/plur) ⭐ 287 \| 🐛 207 \| 🌐 TypeScript \| 📅 2026-09-16                            | -                                                 | Open-source persistent memory for OpenClaw agents. Learn, recall, forget, feedback. Local storage, zero cloud dependency.                                                                                                |
...
| [screenpipe](https://github.com/screenpipe/screenpipe) ⭐ 21,589 \| 🐛 46 \| 🌐 Rust \| 📅 2026-09-16                               | 19k                                               | Local-first screen + audio memory for your agent — records what you see and hear, searchable over MCP (`npx -y screenpipe-mcp`) or a local REST API. Gives OpenClaw recall of your real activity, 100% on-device.        |
...
| [erpclaw](https://github.com/avansaber/erpclaw) ⭐ 102 \| 🐛 2 \| 🌐 Python \| 📅 2026-09-13 | 47    | AI-native open-source ERP + double-entry accounting, self-hosted, run in plain English |
...
| [weixin-codex-bridge](https://github.com/leilong611-ai/weixin-codex-bridge) ⭐ 6 \| 🐛 6 \| 🌐 TypeScript \| 📅 2026-09-14 | 6     | Security-first, local WeChat-to-Codex bridge that reuses an existing Weixin/OpenClaw login state; includes default-deny roles, session isolation, workspace sandboxing, and a durable SQLite inbox. |

### Monitoring & Tools

| Project                                                                                                                                                | Stars   | Description                                                                                                                                                                                                                                                                                                                                                                                                   |
| ------------------------------------------------------------------------------------------------------------------------------------------------------ | ------- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [Manifest](https://github.com/mnfst/manifest) ⭐ 7,526 \| 🐛 107 \| 🌐 TypeScript \| 📅 2026-09-16                                                      | 3.3k    | Real-time cost observability for OpenClaw agents — track tokens, costs, messages, and model usage with a local-first dashboard. Supports 28+ LLM models. [Website](https://manifest.build)                                                                                                                                                                                                                    |
...
| [opik-openclaw](https://github.com/comet-ml/opik-openclaw) ⭐ 725 \| 🐛 14 \| 🌐 TypeScript \| 📅 2026-09-15                                            | 50      | OpenClaw plugin for trace-level observability in Opik. See LLM spans, tool calls, sub-agent spans, usage, and cost metadata. Setup alerts and catch issues with your claw.                                                                                                                                                                                                                                    |
...
| [agenttrace](https://github.com/luoyuctl/agenttrace) ⭐ 134 \| 🐛 7 \| 🌐 Rust \| 📅 2026-09-14                                                         | 32      | Local CLI/TUI for OpenClaw and coding-agent session history, with cost, token, latency, anomaly, and slow-run diagnostics.                                                                                                                                                                                                                                                                                    |
...
| [Claw Lens](https://github.com/msfirebird/claw-lens) ⭐ 377 \| 🐛 0 \| 🌐 TypeScript \| 📅 2026-04-15                                                   | NEW     | Open-source local dashboard for OpenClaw — cost analytics, live monitoring, session inspection, profiler, cache trace, and security audit.                                                                                                                                                                                                                                                                    |
| [ClawStat.us](https://clawstat.us)                                                                                                                     | NEW     | Automated, evidence-backed verdict on whether to update to the latest OpenClaw release — scouts post-release bug reports, scores them from the repo's own severity labels, and has two independent LLMs cross-check the call. Free, open source, with a JSON API and an `llms.txt` mirror for agents. [Source](https://github.com/camilla-oclm/openclaw_status_app) ⭐ 0 \| 🐛 0 \| 🌐 Python \| 📅 2026-09-12 |
| [ClawMetry](https://github.com/vivekchand/clawmetry) ⭐ 416 \| 🐛 70 \| 🌐 Python \| 📅 2026-09-16                                                      | 395     | Real-time observability dashboard for OpenClaw: live sessions, token costs, tool calls, crons, and memory, one pip install.                                                                                                                                                                                                                                                                                   |
...
| [NoizAI/skills](https://github.com/NoizAI/skills) ⭐ 524 \| 🐛 5 \| 🌐 Python \| 📅 2026-05-07                   | NEW   | Human-like TTS workflow skills with local/cloud backends, style presets, and voice message delivery scripts.                                                                                                                                                                                                                                                                               |
...
| Project                                                                                                                               | Stars | Description                                                                                                                                                     |
| ------------------------------------------------------------------------------------------------------------------------------------- | ----- | --------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [awesome-openclaw-agents](https://github.com/mergisi/awesome-openclaw-agents) ⭐ 3,966 \| 🐛 91 \| 🌐 HTML \| 📅 2026-05-25            | 830+  | 177 production-ready AI agent templates across 24 categories. Copy-paste SOUL.md files for PM, Writer, SEO, DevOps, and more.                                   |
...
| [awesome-openclaw-skills](https://github.com/VoltAgent/awesome-openclaw-skills) ⭐ 52,607 \| 🐛 0 \| 📅 2026-09-14                     | -     | Community curated skills collection                                                                                                                             |
...
| [AutoGPT](https://github.com/Significant-Gravitas/AutoGPT) ⭐ 187,381 \| 🐛 569 \| 🌐 Python \| 📅 2026-09-16         | Open Source | Autonomous task execution                                                                                                                                                                                                                      |
| [Open Interpreter](https://github.com/OpenInterpreter/open-interpreter) ⭐ 68,342 \| 🐛 1 \| 🌐 Rust \| 📅 2026-09-15 | Open Source | Terminal-based code execution                                                                                                                                                                                                                  |
| [Claude Code](https://claude.ai/code)                                                                                | Proprietary | Developer coding assistance                                                                                                                                                                                                                    |
| [Tura](https://github.com/Tura-AI/tura) ⭐ 635 \| 🐛 2 \| 🌐 Rust \| 📅 2026-09-13                                    | Open Source | Local open-source coding agent that understands a repository before changing it                                                                                                                                                                |
...
| [Agent Zero](https://github.com/frdel/agent-zero) ⭐ 19,185 \| 🐛 143 \| 🌐 Python \| 📅 2026-09-16                   | Open Source | Fully local autonomous agent                                                                                                                                                                                                                   |
| [Hermes Agent](https://github.com/NousResearch/hermes-agent) ⭐ 246,037 \| 🐛 43,390 \| 🌐 Python \| 📅 2026-09-16    | Open Source | Self-evolving agent with closed learning loop; 18 messaging platforms, 7 backends — includes a native OpenClaw migration path. See [awesome-hermes-agent](https://github.com/SamurAIGPT/awesome-hermes-agent) ⭐ 2,017 \| 🐛 0 \| 📅 2026-08-21 |
| [OpenHuman](https://github.com/tinyhumansai/openhuman) ⭐ 39,817 \| 🐛 196 \| 🌐 Rust \| 📅 2026-09-16                | Open Source | Desktop AI assistant for communities; Tauri + Rust core, multi-channel messaging, knowledge-graph memory, skills, voice, and local or cloud LLM routing                                                                                        |
| [Orkas](https://orkas.ai?source=gh_openclaw)                                                                         | Open Source | Local-first multi-agent desktop workspace; OpenClaw can run as a CLI backend alongside Claude Code, Codex, OpenCode, and Cline. [Source](https://github.com/Orkas-AI/Orkas) ⭐ 1,999 \| 🐛 12 \| 🌐 TypeScript \| 📅 2026-09-16                 |
| [Khoj](https://github.com/khoj-ai/khoj) ⭐ 37,357 \| 🐛 150 \| 🌐 Python \| 📅 2026-08-02                             | Open Source | Open-source personal AI                                                                                                                                                                                                                        |
| [Hivekeep](https://github.com/MarlBurroW/hivekeep) ⭐ 59 \| 🐛 35 \| 🌐 TypeScript \| 📅 2026-09-16                   | Open Source | Self-hosted team of AI agents with persistent memory, web UI, Telegram/Slack/Discord/Matrix                                                                                                                                                    |
...
| Project                                                                                                                                    | Stars | Description                                                                                                                                                                                                                                                                                                               |
| ------------------------------------------------------------------------------------------------------------------------------------------ | ----- | ------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- |
| [aquaman](https://github.com/tech4242/aquaman) ⭐ 37 \| 🐛 2 \| 🌐 TypeScript \| 📅 2026-09-14                                              | -     | Credential isolation proxy — API keys never enter the agent process, injected via UDS from Keychain/1Password/Vault/keepassxc                                                                                                                                                                                             |
| [APort Agent Guardrails](https://github.com/aporthq/aport-agent-guardrails) ⭐ 25 \| 🐛 1 \| 🌐 Shell \| 📅 2026-09-15                      | -     | Pre-action authorization for OpenClaw; `before_tool_call` plugin, allowlist + 40+ blocked patterns, local or API. Setup: `npx @aporthq/agent-guardrails`                                                                                                                                                                  |
...
| [OneCLI](https://github.com/onecli/onecli) ⭐ 3,485 \| 🐛 152 \| 🌐 TypeScript \| 📅 2026-09-14                                             | -     | Open-source credential vault for AI agents. Rust HTTP gateway injects API keys transparently so agents never handle raw secrets. Per-agent scoped tokens, AES-256-GCM encryption at rest.                                                                                                                                 |
